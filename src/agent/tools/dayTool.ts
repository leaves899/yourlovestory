 ...
 */
const dayParameters = Type.Object({
  slug: Type.String({
...
type DayParameters = Static<typeof dayParameters>

function errorText(error: unknown): string {
  return error instanceof Error ? error.message : String(error)
}

export const dayTool: AgentTool<typeof dayParameters, { success: boolean; error?: string }> = {
  name: 'day_writer',
  label: 'Day Writer',
